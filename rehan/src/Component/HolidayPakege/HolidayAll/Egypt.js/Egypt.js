...
import HolidayTravelForm from '../../finalForm/HolidayTravelForm'
           ...
           <div className='column-holiday' >
            {cards.map((location,index) => (
                <div key={index} className='contain-holiday shadow-lg px-4 py-4'>
                  <img src='egypt.jpg' alt='' className='img'></img>
              ...
              <div class="contact" className=' shadow-xl h-[74vh] w-[25%] px-6 sticky top-10 lg:top-10 md:inset-1 lg:w-[25%] w-full' >
                <h1>Contact</h1>
